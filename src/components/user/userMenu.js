      ...
      if (menuMeals.Menu) {
        ...
        return (
          <tbody>
            <tr>
              <td>
                <div className="panel-body" id="no-menu">
                  {" "}
                  Start by selecting a menu...
                </div>
              </td>
            </tr>
          </tbody>
        ...
        menuMeals.Menu.map((menuMeal, index) => {
          if (menuMeal.mealId !== null) {
            return (
              <tbody>
                <UserMenuView menuMeal={menuMeal} key={index} />
              </tbody>
            );
          }
        });
        ...
        if (menuList === null) {
          return (
            <tbody>
              <tr>
                <td>
                  <div className="panel-body" id="no-session">
                    {" "}
                    Start by selecting a menu...
                  </div>
                </td>
      ...
      <div>
        <div className="panel-body panel-meals" style={{ height: "405px" }}>
          <div className="content">
            <table className="menu">{this.DisplayMenus(menuMeals)}</table>
          </div>
        </div>
      </div>
    );
